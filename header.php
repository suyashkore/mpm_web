...
$page_name = formatPageName($current_page);
if($page_name == 'Index'){
  $page_name='Dashboard';
}
?>
...
<head>
  ...
  <title>Monarch : <?php echo $page_name; ?></title>
  <meta content="" name="description">
  <meta content="" name="keywords">

  <!-- Favicons -->
  <link href="assets/img/mpm_logo.png" rel="icon">
  <link href="assets/img/mpm_logo.png" rel="apple-touch-icon">
  ...
  <!-- =======================================================
   bootstrap version: Apr 20 2024  v5.3.3
  ======================================================== -->
</head>
      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
            <img src="assets/img/avtar.jpg" alt="Profile" class="rounded-circle">
