        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                ...
                <form id="initiateProject" action="./controller/ctrl_project_initiation.php" method="post">
                    <input type="hidden" name="project_id" id="project_id" value="<?php if(isset($project)) echo $project['project_id']; ?>">
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="Date" name="project_strat_date" class="form-control"
                                            id="projectStratDate" min="<?php echo $today; ?>" required>
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="project_complition_time" class="form-control"
                                            id="projectComplitionTime" required oninput="getDate();">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="sales_person_name" class="form-control"
                                            id="salesPersonName" required oninput="salesName()">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select id="projectType" name="project_type" class="form-select">
                                            <option selected>Choose...</option>
                                            <option>New Track Survey</option>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select id="projectManager" name="project_manager" class="form-select"  onchange="getSelectedManager();">
                                            <option selected>Choose...</option>
                                            <?php 
                                    foreach($manager['manager'] as $ma){
                                        // print_r($ma);
                                        ?>
                                            <option value="<?php echo $ma['emp_id']; ?>">
                                                <?php echo $ma['name']; ?></option>
                                            <?php
                                    }
                                    ?>
                                        </select>
                                    ...
                                    <div class="col-md-6" id="pamt" style="display:none;">
                                        ...
                                        <input type="text" name="profit_loss_amount" class="form-control"
                                            id="profitAmount">
                                    </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-12">
                                        <label for="projectManager_assign" class="form-label">Project Manager</label>
                                        <input type="text" name="projectmanager" class="form-control"
                                            id="projectManager_assign">
                                    </div>
                                    <div class="col-md-12">
